...
include ("config.php");
$sql = "SELECT pname,pid FROM `products`";
          ...
          <div class="">
            ...
            <form method="post"class="form-horizontal form-label-left" novalidate>
                      ...
                      <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bname">User Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="bname"   type="text" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="buname"  required>
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="bregnumber" name="bregno" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12" required >
                        </div>
                      </div>
                        ...
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="utype">Product Name <span>*</span>
                          ...
                          <div class="btn-group">
                              <div class="col-md-6 col-sm-6 col-xs-12">
                           <select name="pname1" style="height:35px; width:590px; margin-left: 1px; border-radius:2px; ">
...
<!--                               <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="bregnumber" name="bpcode"  data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12"  required>
                        </div>
                      </div>-->
                            
                            <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bpcount">pcount <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="number" id="bregnumber" name="bpcount"  data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12" required>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          ...
                          <button id="send" type="submit" name="bsubmit"class="btn btn-success">Submit</button>
                        </div>
                      </div>
                    </form>
                  </div>
...
//            $bpcode=$_POST["bpcode"];
        ...
        $sql="INSERT INTO barrow(uname,regno,pid,pcount)
              VALUES('$buname','$bregno','$pid','$bpcount')";    
        $sql1="UPDATE products SET pcounts = pcounts - $bpcount WHERE pid= $pid";
        $con->query($sql1);
        if($con->query($sql))
        {
