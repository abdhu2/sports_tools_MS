              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/12.jpeg" alt="">SEUSL Admin
             ...
             <?php
                      ...
                      if($result->num_rows>0)
                      {
                          ...
                          while($row=$result->fetch_assoc())
                          {
                              ...
                              echo"<td>{$row["pcounts"]}</td>";
                              
                              echo"<td><a href=editpro.php?edit=".$row['pid']."><button type='button' class='btn btn-sm btn-info'><i class='fa fa-edit'></i></button></a></td>";
                             //echo"<td><a href=editpro.php?edit=".$row['pid']."><button style='background-color:red; color:white;'>Edit</button></a></td>";
                                echo"<td><a href=deleteproduct.php?id=".$row['pid']."><button type='button' name='del' class='btn btn-round btn-danger'><i class='fa fa-trash'></i></button></a></td>";
                                //echo"<td><a href=deleteproduct.php?id=".$row['pid']."><button style='background-color:red; color:white;'>delete</button></a></td>";
