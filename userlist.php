  ...
  <body class="nav-md">
    <div class="container body">
      <div class="main_container">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="#"><i class="fa fa-group"></i>User List</a>
        ...
        <!-- page content -->
        <div class="right_col" role="main" id="output">
            <div class="x_title">
                      <h2 style="color: #37B6B1;"><B>USERS DETAILS.</b></h2>
