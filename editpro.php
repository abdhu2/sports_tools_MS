...
include ("config.php");
$userid=$_GET['edit'];
$query="SELECT * FROM products WHERE pid='".$userid."'";
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  ...
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    ...
                    <li><a href="index1.php"><i class="fa fa-sign-out pull-right"></i> Log Out</li></a>
                  </ul>
                </li>
                  </div>
        </div>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                      <h2 style="color: #37B6B1;"><B>UPDATE PRODUCTS DETAILS HERE.</b></h2>
                   
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form  action="updateproduct.php" method="post"id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                        <input name="id" type="hidden" value="<?php echo $userid; ?>">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pname" >Product Name <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="pname" name="pname" class="form-control col-md-7 col-xs-12" value="<?php echo $pname ?>" required>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="pcode" name="pcode"  class="form-control col-md-7 col-xs-12" value="<?php echo $pcode ?>" required>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="pcount" class="control-label col-md-3 col-sm-3 col-xs-12">Products Counts</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="pcount" class="form-control col-md-7 col-xs-12" type="number" name="pcount" value="<?php echo $pcount ?>"required>
                        </div>  
                      </div>
